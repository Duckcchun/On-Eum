...
<p align="center">
  <strong>에어팟 끼고 걸을 때, AI가 위험 소리를 대신 들어줍니다.</strong>
</p>
...
에어팟 노이즈 캔슬링으로 음악을 들으며 걷다가, 뒤에서 오는 **전동 킥보드를 못 듣고** 아찔한 경험 해보신 적 있나요?

**온음**은 그 순간을 막아줍니다.

> 마이크가 주변 소리를 실시간으로 분석하고,
> 킥보드·오토바이·차량이 다가오면 **0.2초 이내에**
> 에어팟으로 경고음 + 강한 진동으로 알려줍니다.
